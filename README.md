...
“Personalized Mandarin Reading Learning Assistant” is a Generative AI system powered by a Large Language Model (LLM) that can adapt Mandarin reading materials to meet users’ Mandarin proficiency levels. With China’s rise in the twenty-first century, global demand for Chinese as a second language proficiency has surged (Tsai & Chang, 2025). As increasing numbers of international students come to Taiwan to learn Mandarin and prepare for the Test of Chinese as a Foreign Language (TOCFL), the demand for effective learning materials and AI-assisted educational tools continues to grow. In response to this growing demand, the development of learning materials and assisting tools has become increasingly crucial. Previous research suggests that reading materials aligned with learners' proficiency levels improve comprehension and learning outcomes (Klare, 2000). Despite recent advances in LLMs, there is still no widely adopted system capable of automatically adapting Mandarin reading materials to individual learners' proficiency levels, which shows a need for a personalized reading support system to help learners achieve better reading comprehension.

We manually collected 115 Mandarin reading texts as the knowledge base for the system. The system integrates graded vocabulary resources, CKIP Transformers, MongoDB, and Retrieval-Augmented Generation (RAG). Based on our RAG framework, carefully designed prompts, and learners’ Mandarin proficiency levels, the LLM rewrites user-provided texts and generates Mandarin reading materials which are tailored to learners' Mandarin proficiency levels. We also developed evaluation methods to assess whether the generated content matches the target proficiency level while preserving the original meaning. However, the system is still limited by the size of the dataset and potential bias in knowledge base selection. This project demonstrates the potential of Generative AI to support personalized Mandarin language learning by generating accessible reading materials that improve learners' reading comprehension and engagement.
